class Dualsensejs{
    ...
    async init() {
        ...
        this.device.addEventListener("inputreport", async event => {
            ...
            // Handle only the Dualsense device.
            if (device.productId !== 0x0ce6) return
    ...
    updateOutputReport(){
        if(!this.isOutputBufferUpdated) this.isOutputBufferUpdated = true;
    }
    ...
    setPlayerNumber(number){
        this.outputReportBuffer[43] = number;
        this.updateOutputReport();
    }
